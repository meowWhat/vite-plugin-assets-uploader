...
var PathHelper_1 = require("./helper/PathHelper");
var AssetsMaintainer = /** @class */ (function () {
    ...
    AssetsMaintainer.prototype.pushAssetsToOss = function () {
        return __awaiter(this, void 0, void 0, function () {
            var ossClient_1, error_1, filesToPush_1, assetDir, absFiles, absFiles_1, absFiles_1_1, absFile, stat, relativeFile, filename, sizeS, queues, sliceCount_1, _loop_1, i, len, error_2;
            var e_1, _a;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        _b.trys.push([5, 7, , 8]);
                        filesToPush_1 = [];
                        assetDir = PathHelper_1.pathHelper.join(this.options.root, this.options.assetsDir).replace(/\/$/, '');
                        ...
                        try {
                            for (absFiles_1 = __values(absFiles), absFiles_1_1 = absFiles_1.next(); !absFiles_1_1.done; absFiles_1_1 = absFiles_1.next()) {
                                ...
                                filesToPush_1.push({ filename: filename, absFile: absFile, size: sizeS });
                            }
                        }
                        ...
                        this.filesToPushLen = filesToPush_1.length;
                        queues = [];
                        sliceCount_1 = 5;
    ...
    AssetsMaintainer.prototype.uploadFile = function (_a) {
        var absFile = _a.absFile, filename = _a.filename, size = _a.size;
        var res = fs.readFileSync(absFile);
        var filePath = PathHelper_1.pathHelper.join(this.options.savePath, filename);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!options.roleArn) return [3 /*break*/, 2];
                    ...
                    case 2: return [2 /*return*/, new AliOss_1.AliOss({
                            accessKeyId: options.accessKeyId,
                            accessKeySecret: options.accessKeySecret,
                            bucket: options.bucket,
                            region: options.region
